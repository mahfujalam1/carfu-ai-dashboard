          ...
          <div className="flex justify-between gap-1 md:gap-2">
            {otp.map((digit, index) => (
              <input
                ...
                className="w-10 h-10 md:w-14 md:h-14 bg-[#1A1C1E] border-none rounded-xl text-white text-center text-xl font-bold focus:ring-1 focus:ring-blue-500 shadow-inner"
                maxLength={1}
              />
            ))}
          </div>
